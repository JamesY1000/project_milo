...
: ${AMENT_CURRENT_PREFIX:="/root/milo_ws/install/example_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/example_pkg/environment/pythonpath.sh"
